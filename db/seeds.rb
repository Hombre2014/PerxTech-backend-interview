...
450.times do
  Purchase.create(user_id: Faker::Number.between(from: 1, to: 10), date: Faker::Date.between(from: '2020-01-01', to: Date.today), amount: Faker::Number.between(from: 80, to: 600), country_of_purchase: Faker::Address.country, counted: false, processed_for_points: false, checked_for_5_percent_rewards: false, checked_for_free_movie_tickets: false)
end
